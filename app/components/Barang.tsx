...
export default function Barang({ id, gambar, kategori, nama, harga }) {
  return (
    <section className="rounded-md shadow-lg w-fit">
      <div className="relative overflow-hidden" style={{ width: "250px", height: "250px" }}>
        <Image
          ...
          style={{ transition: "opacity 0.3s ease-in-out", objectFit: "cover", objectPosition: "center", width: "100%", height: "100%" }}
          src={gambar}
          width={950}
          height={250}
          alt="produk"
